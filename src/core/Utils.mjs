...
class Utils {
     ...
     * Unicode Private Use Area, which Tau will display as control characters.
     ...
     * Private Use Area, which Tau will display as a control character picture.
     ...
     * -._~!$&'()*+,;=:@/?
     *
     * & and = are still escaped as they are used to serialise the key-value pairs in Tau
     ...
     *
     * "Pretty" Tau recipe formats are designed to be included in the fragment (#) or query (?)
     * parts of the URL. They can also be loaded into Tau through the 'Load' interface. In order
